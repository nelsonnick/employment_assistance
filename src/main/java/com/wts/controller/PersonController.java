...
public class PersonController extends Controller {
    ...
    public void save() {
        if (Person.dao.find("SELECT * FROM person WHERE person_number = ? AND state = 1", getPara("person[number]")).size() != 0) {
            ...
            System.out.println(getPara("person[number]"));
            System.out.println(getPara("person[phone]"));
            System.out.println(getPara("person[address]"));
            System.out.println(getPara("person[company]"));
            System.out.println(getPara("person[job]"));
            System.out.println(getPara("person[timeA]"));
            System.out.println(getPara("person[timeB]"));
